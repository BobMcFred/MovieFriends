...
module.exports = function(app, passport, fs, Movie, userMovie) {
    ...
    // Profile section - this was implemented before angular, and doesn't get used
    ...
    // home section - this was implemented before angular, and doesn't get used
...
function isLoggedIn(req, res, next) {
    ...
    // redirect to home if not in session
    res.redirect('/');
}